...
function MyJourneySection() {
  const steps = [
    ...
    },
    {
      ...
      description: 'Architected functional web platforms, transforming conceptual code bases into responsive interfaces and CRUD applications.',
    ...
    },
    {
      ...
      description: 'Engineered semantic search capabilities, orchestrating vector database layers and custom LLM retrieval pipelines.',
