function CaseStudySection({ eyebrow, title, children, contentClassName = '' }) {
  return (
    <section className="rounded-3xl border border-gray-200/50 bg-white p-7 shadow-sm sm:p-8">
      ...
      <div
        className={`${title ? 'mt-5' : 'mt-4'} space-y-4 text-base leading-7 text-gray-600 ${contentClassName}`.trim()}
      >
        {children}
      </div>
    </section>
