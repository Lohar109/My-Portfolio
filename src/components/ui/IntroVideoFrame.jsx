...
function IntroVideoFrame() {
  ...
  return (
    <div className="relative w-full max-w-[640px] lg:max-w-none">
      ...
      <div 
        ref={playerRef}
        className="group relative aspect-[16/10] w-full overflow-hidden rounded-[2rem] border border-gray-150 bg-black shadow-[0_32px_64px_-12px_rgba(0,0,0,0.12)] transition-all duration-500 hover:shadow-[0_40px_80px_-10px_rgba(99,102,241,0.15)]"
      >
