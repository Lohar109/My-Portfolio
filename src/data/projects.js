export const projectsData = [
  ...
  },
  {
    ...
    images: [
      ...
      '/Loading images/14.png',
      '/Loading images/15.png',
      '/Loading images/16.png',
      '/Loading images/17.png',
      '/Loading images/18.png',
      '/Loading images/19.png',
      '/Loading images/20.png',
      '/Loading images/21.png',
      '/Loading images/22.png',
      '/Loading images/23.png',
      '/Loading images/24.png',
      '/Loading images/25.png',
      '/Loading images/26.png',
      '/Loading images/27.png',
      '/Loading images/28.png',
      '/Loading images/29.png',
      '/Loading images/30.png',
    ],
    previewTone:
