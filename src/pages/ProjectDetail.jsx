      ...
      return [
        {
          ...
          iconColor: 'text-rose-700',
          iconBg: 'bg-rose-50',
          title: 'No unified view of candidate',
          description: 'Resume, GitHub, and portfolio each tell part of the story, but nothing combines them into one career profile.',
        },
        {
          icon: Shield,
          iconColor: 'text-amber-700',
          ...
          description: 'Most resume checkers give keyword-matching scores with no context on target roles or experience.',
        },
        {
          icon: Terminal,
          iconColor: 'text-indigo-700',
          ...
          description: 'Candidates rehearse answers alone with no feedback loop simulating a real recruiter conversation.',
        },
        {
          icon: Search,
          iconColor: 'text-sky-700',
          ...
          description: "Applicants can't easily tell how well their profile matches a specific job description before applying.",
        },
        {
          icon: BrainCircuit,
          iconColor: 'text-emerald-700',
          iconBg: 'bg-emerald-50',
          title: 'No structured growth path',
          description: 'There is no single place tracking what skills to learn next, or how close someone is to being job ready.',
        },
        {
          icon: Users,
          iconColor: 'text-violet-700',
          iconBg: 'bg-violet-50',
          title: 'Incomplete signals for recruiters',
          description: 'Sharing a static resume PDF loses all the live context of code quality and portfolio history.',
        },
      ]
    case 'shopease-landing':
      return [
    ...
    steps: [
      {
        ...
        iconColor: 'text-violet-600',
        iconBg: 'bg-violet-50',
        title: 'Foundation & Security First',
        description: 'Set up Supabase (Postgres + Auth + Storage) with RLS on every table, encrypted GitHub OAuth tokens, and Zod validation.',
      },
      {
        icon: User,
        iconColor: 'text-indigo-600',
        ...
        description: 'Built PDF upload, parsing via unpdf, Gemini-based analysis, and ATS score feedback display.',
      },
      {
        icon: GitFork,
        iconColor: 'text-emerald-600',
        ...
        description: 'Connected via OAuth to trigger repo/activity fetch and run AI-generated code quality and profile analysis.',
      },
      {
        icon: Sparkles,
        iconColor: 'text-amber-600',
        iconBg: 'bg-amber-50',
        title: 'Career Twin Overview',
        description: 'Aggregated resume, GitHub, and portfolio data into a single career summary score, cached for fast reloading.',
      },
      {
        icon: Terminal,
        iconColor: 'text-rose-600',
        iconBg: 'bg-rose-50',
        title: 'Job Match, Interview & roadmaps',
        description: 'Added job description matching, AI mock interviews with conversational loops, and learning roadmaps.',
      },
      {
        icon: Eye,
        iconColor: 'text-sky-600',
        iconBg: 'bg-sky-50',
        title: 'Shareable Recruiter View',
        description: 'Designed a read-only curated public view (/r/[slug]) exposing live, data-backed candidate profiles.',
      },
    ],
    principles: [
      {
        ...
        description: 'Row-Level Security on every table, encrypted OAuth tokens, and signed URLs for resume storage.',
      },
      {
        icon: LayoutGrid,
        iconColor: 'text-sky-600',
        ...
        description: 'Every layout fully responsive across break points, with a collapsible sheet navigation bar.',
      },
      {
        icon: Cpu,
        iconColor: 'text-emerald-600',
        ...
        description: 'Heavy parsing and AI analysis jobs run asynchronously in background pipelines using Inngest.',
      },
      {
        icon: Shield,
        iconColor: 'text-rose-600',
        iconBg: 'bg-rose-50',
        title: 'Validated API Pipelines',
        description: 'Zod schemas guard and validate every API route before reaching Supabase or the Gemini API.',
      },
    ],
  }
}
  ...
  return [
    {
      ...
      iconBg: 'bg-violet-50',
      title: 'Resume Intelligence',
      description: 'Upload a resume PDF to get an AI-generated ATS score with section-by-section improvement feedback.',
    },
    {
      icon: GitFork,
      iconColor: 'text-emerald-600',
      iconBg: 'bg-emerald-50',
      title: 'GitHub Intelligence',
      description: 'Connect via OAuth to trigger an AI analysis of repositories, code quality, and contribution activity.',
    },
    {
      icon: Sparkles,
      iconColor: 'text-amber-600',
      iconBg: 'bg-amber-50',
      title: 'Career Overview ("Career Twin")',
      description: 'A single aggregated score and career summary combining resume, GitHub, and portfolio records.',
    },
    {
      icon: Search,
      iconColor: 'text-rose-600',
      ...
      description: 'Paste a job description to get a fit score highlighting matching skills and identifying keyword gaps.',
    },
    {
      icon: Terminal,
      iconColor: 'text-sky-600',
      ...
      description: 'Interactive voice or text mock interview sessions with realistic follow-up questions and post-session scoring.',
    },
    {
      icon: BrainCircuit,
      iconColor: 'text-indigo-600',
      iconBg: 'bg-indigo-50',
      title: 'Career Roadmap & Learning Hub',
      description: 'A personalized, trackable roadmap of goals and resources tailored to bridge missing skill gaps.',
    },
    {
      icon: LayoutGrid,
      iconColor: 'text-purple-600',
      iconBg: 'bg-purple-50',
      title: 'Projects Hub & Achievements',
      description: 'A central page to manage projects and milestones, featuring AI-expanded descriptions.',
    },
    {
      icon: Eye,
      ...
      iconBg: 'bg-teal-50',
      title: 'Shareable Recruiter View',
      description: 'Generate public read-only links (/r/[slug]) exposing a live, curated candidate profile.',
    },
    {
      icon: Activity,
      iconColor: 'text-pink-600',
      iconBg: 'bg-pink-50',
      title: 'Progress Tracker & Settings',
      description: 'Ongoing tracking of roadmap goals, account privacy controls, and security configurations.',
    },
  ]
}
